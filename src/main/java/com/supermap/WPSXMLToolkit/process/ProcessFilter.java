 ...
 * <p>
 * Use cases for this interface are static configuration of available processes from the existing
 * factories, security restrictions based on the current user, and general verification and
 * manipulation of process inputs and outputs.
 * </p>
...
public interface ProcessFilter {
     ...
     * <p>
     * The factory provided by this method might have been wrapped already by another filter, so
     * don't assume it's possible to make an instance-of check against it to recognize a particular
     * factory. In case {@link DelegatingProcessFactory} is used the
